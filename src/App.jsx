...
function Dashboard(){
  ...
  return(<div style={{background:C.bg,minHeight:"100vh",color:C.text,fontFamily:"'IBM Plex Sans','Pretendard',system-ui,sans-serif"}}>
    ...
    <div style={{padding:"16px 20px",maxWidth:1200,margin:"0 auto"}}>
      ...
      {tab==="weekly"&&<><PeriodNav keys={Object.keys(WS)} current={weekKey} onChange={setWeekKey} colorActive={C.weekly}/><WeeklyTab weekKey={weekKey} WS={WS}/></>}
